// Museum map SVG file
// all the paths have been split into a list with different groups. This allows for interaction with different group elements whilst also improving accessibility.
// tab targeting through the museum paths will read out the exhibition title and description (dictated by "aria-labelledby")

// custom classes added to the interactable and non-interactable elements, with on hover effects
  ...
  >
    ...
    <g role="list" className="interactable-path-list">
      ...
      <Tooltip hasArrow labe="Exhibit 1 - Space Theme">
        <g role="listitem" className="interactable-item">
          <a
            href="/exhibition-1"
      ...
      {/* Exhibition 2 - no interaction */}
      <g role="listitem" className="no-svg-click">
        {/* <a
          href="/exhibition-2"
